...
const Certificates = () => {
  ...
  // const { courses, currentUser, enrollments, batches } = useAppContext();
        ...
        <div className="lg:col-span-2">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-gray-600 mb-4">
              আপনার সার্টিফিকেট যাচাই করতে নিম্নের তথ্য ব্যবহার করুন:
            </p>
            <div className="space-y-3">
              {certificates
                .filter((cert) => cert.status === "জারিকৃত")
                .map((cert) => (
                  <div
                    key={cert._id}
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-gray-500">যাচাইকরণ কোড</p>
                    </div>
                  </div>
                ))}
            </div>
            <div className="mt-4 p-3 bg-blue-50 rounded-lg">
              <p className="text-sm text-blue-800">
                <strong>যাচাইকরণ লিংক:</strong> https://ctc-edu.com/verify
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
                ...
                <div className="text-center">
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-gray-700 mb-6">
                      কোর্স কোড: {selectedCertificate.courseCode}
                    </p>
                  </div>

                  {/* Details Grid */}
                  <div className="grid grid-cols-3 gap-6 mb-8 text-sm border-t-2 border-b-2 border-green-600 py-6">
                    <div>
                      <p className="text-gray-600 mb-2">গ্রেড</p>
                      <p className="font-bold text-lg text-gray-900">
                        {selectedCertificate.grade}
                      </p>
                    </div>
                    <div>
                      <p className="text-gray-600 mb-2">স্কোর</p>
                      <p className="font-bold text-lg text-gray-900">
                        {selectedCertificate.percentage}%
                      </p>
                    </div>
                    <div>
                      <p className="text-gray-600 mb-2">মেয়াদ</p>
                      <p className="font-bold text-lg text-gray-900">
                  ...
                  {/* Footer Section */}
                  <div className="border-t-2 border-green-600 pt-6 mt-6">
                    <div className="flex justify-between items-start mb-6">
                      <div className="text-left">
                        <p className="text-sm text-gray-600">সার্টিফিকেট নং:</p>
                      ...
                      <div className="text-center">
                        <div className="w-24 h-24 bg-green-100 rounded-full flex items-center justify-center mb-2 border-2 border-green-600">
                      ...
                      <div className="text-right">
                        <p className="text-sm text-gray-600">শিক্ষক:</p>
                        <p className="text-sm font-medium text-gray-900">
            ...
            <div className="flex justify-end space-x-3 px-6 py-4 border-t border-gray-200 bg-gray-50">
              ...
              <button
                ...
                className="px-4 py-2 text-sm bg-gray-600 text-white rounded-lg hover:bg-gray-700 flex items-center transition-colors"
              >
              ...
              <button
                ...
                className="px-4 py-2 text-sm bg-purple-600 text-white rounded-lg hover:bg-purple-700 flex items-center transition-colors"
              >
              ...
              <button
                ...
                className="px-4 py-2 text-sm bg-green-600 text-white rounded-lg hover:bg-green-700 flex items-center transition-colors"
              >
