...
const StudentDashboard = () => {
  ...
  //     try {
  //       // প্রতিটি batch এর schedules load করুন
  //       const schedulesData = {};
  //       const attemptsData = {};

  //       for (const batch of myBatches) {
  //         // Schedules
  //         const schedules = await getSchedulesByBatch(batch._id);
  //         schedulesData[batch._id] = schedules;

  //         // MCQ Attempts
  //         const attempts = await fetchStudentResults(
  //           currentUser._id,
  //           batch._id
  //         );
  //         attemptsData[batch._id] = attempts;
  //       }

  //       // setBatchSchedules(schedulesData);
  //       console.log(schedulesData);
  //       setStudentResults(attemptsData);
  //     } catch (error) {
  //       console.error("Batch data load error:", error);
  //     }
  //   };

  //   loadBatchData();
  // }, [myBatches, currentUser]);
                      ...
                      >
                        ...
                        <div className="card-body">
                          ...
                          <div className="flex justify-between mt-4">
                            ...
                            <button
                              onClick={() => {
                                // আগের activeTab localStorage এ রেখে দাও
