...
const StudentDetails = () => {
  ...
  const { students, batches, courses, enrollments, attendance, payments } =
    useAppContext();
  ...
  if (!student) {
    return (
      <div className="text-center py-20">
        ...
        <h2 className="text-2xl font-bold mb-4">ছাত্র পাওয়া যায়নি</h2>
        <button
          onClick={() => navigate("/dashboard/admin/students/search")}
  ...
  return (
    <div className="space-y-6 p-6 bg-base-200 min-h-screen">
      ...
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-3xl font-bold">ছাত্রের বিস্তারিত তথ্য</h1>
      </div>
      ...
      <div className="bg-base-100 rounded-lg shadow-lg p-6">
        ...
        {activeTab === "batches" && (
          <div>
            <h2 className="text-2xl font-bold mb-4">ভর্তিকৃত ব্যাচসমূহ</h2>
        ...
        {activeTab === "attendance" && (
          <div>
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-bold">উপস্থিতির রেকর্ড</h2>
        ...
        {activeTab === "payments" && (
          <div>
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-bold">পেমেন্ট হিস্ট্রি</h2>
